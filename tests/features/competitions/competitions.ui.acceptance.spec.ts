...
test.describe('Competitions UI Acceptance @competitions @ui @desktop', () => {
  ...
  test('search with no match shows the empty state @acceptance', async ({ competitionsScreen }) => {
    await competitionsScreen.navigate();
  ...
  test('search by competition name shows that competition only @acceptance', async ({ competitionsScreen }) => {
    await competitionsScreen.navigate();
  ...
  test('search by partial competition name shows that competition only @acceptance', async ({ competitionsScreen }) => {
    await competitionsScreen.navigate();
