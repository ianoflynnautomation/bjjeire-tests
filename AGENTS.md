...
- Browser exploration uses Playwright MCP or the official CLI skill installed at
  `.claude/skills/playwright-cli/SKILL.md` (`npx playwright cli install --skills`).
  The agents layout is `.agents/skills/playwright-cli/`.
